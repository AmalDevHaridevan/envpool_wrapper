 ...
 */
#define REGISTER(MODULE, SPEC, ENVPOOL, SPECNAME, POOLNAME)                              \
  py::class_<SPEC>(MODULE, SPECNAME, py::metaclass(abc_meta))       \
  ...
  py::class_<ENVPOOL>(MODULE, POOLNAME, py::metaclass(abc_meta)) \
